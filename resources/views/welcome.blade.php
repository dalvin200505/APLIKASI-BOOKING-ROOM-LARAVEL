...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('assets/img/logoroomoro.jpg') }}" type="image/x-icon">
    <!-- Google Fonts -->
...
<body data-spy="scroll" data-target="#navbar-example">
    ...
    <div id="home" class="slider-area">
        ...
        <div id="ensign-nivoslider" class="slides">
            <img src="{{ asset('assets/img/slider/fmk.jpg') }}" alt="" title="#slider-direction-1" />
            <img src="{{ asset('assets/img/slider/fmk (2).jpg') }}" alt="" title="#slider-direction-2" />
            <img src="{{ asset('assets/img/slider/fmk (3).jpg') }}" alt="" title="#slider-direction-3" />
    ...
    <div id="about" class="about-area area-padding">
        ...
        <div class="row">
            ...
            <div class="well-left">
                ...
                <a href="#">
                    <img src="{{ asset('assets/img/slider/fmk (3).jpg') }}" alt="" style="width: 500px;">
                </a>
                </div>
            </div>
            </div>
